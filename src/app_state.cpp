...
uint16_t zeroWarmupRejectedCount = 0;
bool zeroWarmupPrevValid = false;
float zeroWarmupPrevRoll = 0.0f;
float zeroWarmupPrevPitch = 0.0f;
float zeroWarmupPrevYaw = 0.0f;
float zeroWarmupYawUnwrapped = 0.0f;
float zeroYawBiasRateDps = 0.0f;
uint32_t zeroApplyMs = 0;
bool yawAutoZeroActive = false;
uint32_t yawAutoZeroStableMs = 0;
uint16_t yawAutoZeroUpdates = 0;
float yawAutoZeroCorrectionDeg = 0.0f;
float imuRawRollDeg = 0.0f;
float imuRawPitchDeg = 0.0f;
float imuRawYawDeg = 0.0f;
float imuQuatW = 1.0f;
float imuQuatX = 0.0f;
float imuQuatY = 0.0f;
float imuQuatZ = 0.0f;
bool imuQuatValid = false;
bool imuUsingQuat9 = false;
int16_t imuQuatAccuracy = -1;

float lastYaw          = 0.0f;
unsigned long lastMove = 0;
uint32_t lastYawSampleMs = 0;
